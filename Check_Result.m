h = fopen('C:\Users\G551\Desktop\MFCC\Output_Hardware/output_file_result.txt','r'); %%% NOTE
nextline = '';
str='';
...
% % % % % % % % % % % % % % % % % % % % 
path = 'C:\Users\G551\Desktop\MFCC\Output_Matlab/Result.mat';  %%%NOTE
load(path);

Error_Result = Result_hardware(1:size(Result)) - Result; %%% NOTE
clc;
h = fopen('C:\Users\G551\Desktop\MFCC\Output_Hardware/output_file_win.txt','r');
nextline = '';
str='';
...
window_data_hardware = ftp;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
path = 'C:\Users\G551\Desktop\MFCC\Output_Matlab/window_out_data_morong.mat';
load(path);
Error_Win = window_out_data_morong - window_data_hardware(1: size(window_out_data_morong));

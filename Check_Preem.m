clc;
h = fopen('C:\Users\G551\Desktop\MFCC\Output_Hardware/output_file_preem.txt','r');
nextline = '';
str='';
...
preem_data_hardware = ftp;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load ('C:\Users\G551\Desktop\MFCC\Output_Matlab/preem_blocking_out_data.mat','preem_blocking_out_data');

Error_Preem = preem_blocking_out_data - preem_data_hardware(1: size(preem_blocking_out_data));
clc;
h = fopen('C:\Users\G551\Desktop\MFCC\Output_Hardware/output_file_mel.txt','r');
nextline = '';
str='';
...
mel_data_hardware = ftp;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
path = 'C:\Users\G551\Desktop\MFCC\Output_Matlab/log_out_data.mat';
load(path);
Error_Mel = log_out_data - mel_data_hardware(1:size(log_out_data));

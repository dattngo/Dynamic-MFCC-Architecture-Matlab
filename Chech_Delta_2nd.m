clc;
h = fopen('C:\Users\G551\Desktop\MFCC\Output_Hardware/output_file_delta_2nd.txt','r'); %% output_file_log chinh la energy, chu khong phai ket qua LOG sau mel.
nextline = '';
str='';
...
Delta_2nd_hardware = ftp;

% % % % % % % % % % % % % % % % % % % % 
path = 'C:\Users\G551\Desktop\MFCC\Output_Matlab/delta_2nd_out_data.mat';
load(path);

Error_Delta_2nd = Delta_2nd_hardware (1 : size (delta_2nd_out_data)) - delta_2nd_out_data;

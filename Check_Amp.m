h = fopen('C:\Users\G551\Desktop\MFCC\Output_Hardware/output_file_amp.txt','r');
nextline = '';
str='';
...
amplitude_hardware = ftp;

% % % % % % % % % % % % % % % % % % % % 
path = 'C:\Users\G551\Desktop\MFCC\Output_Matlab/amplitude_out_data.mat';
load(path);

Error_Amp = amplitude_hardware(1: size(amplitude_out_data)) - amplitude_out_data;
